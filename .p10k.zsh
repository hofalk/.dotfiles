# Generated by Powerlevel10k configuration wizard on 2021-01-07 at 10:00 CET.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:-[$P9K_KUBECONTEXT_CLOUD_NAME] }:#\[\] }'
